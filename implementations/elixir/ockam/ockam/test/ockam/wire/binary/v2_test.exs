defmodule Ockam.Wire.Binary.V2.Tests do
  ...
  describe "Ockam.Wire.V2" do
    ...
    test "encode/1 for UDP" do
      ...
      assert {:ok, <<2, 2, 2, 7, 0, 127, 0, 0, 1, 160, 15, 0, 7, 112, 114, 105, 110, 116, 101, 114, 1, 2, 7, 0, 127, 0, 0, 1, 184, 11, 5, 104, 101, 108, 108, 111>>} = V2.encode(message)
    end
    ...
    test "encode/1 for UDP (minimal)" do
      ...
      assert {:ok, <<2, 1, 2, 7, 0, 127, 0, 0, 1, 160, 15, 0, 0>>} = V2.encode(message)
    end


    test "decode/1 for UDP" do
      # TODO: make sure this is valid
      encoded = <<2, 2, 2, 7, 0, 127, 0, 0, 1, 160, 15, 0, 7, 112, 114, 105, 110, 116, 101, 114, 1, 2, 7, 0, 127, 0, 0, 1, 184, 11, 5, 104, 101, 108, 108, 111>>
    ...
    test "decode/1 for TCP" do
      ...
      encoded = <<2, 1, 1, 7, 0, a, b, c, d, 160, 15, 0, 0>>
