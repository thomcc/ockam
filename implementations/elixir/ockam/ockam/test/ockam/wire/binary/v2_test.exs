defmodule Ockam.Wire.Binary.V2.Tests do
  ...
  describe "Ockam.Wire.V2" do
    ...
    test "encode/1 for UDP" do
      ...
      assert {:ok, <<1, 2, 2, 7, 0, 127, 0, 0, 1, 160, 15, 0, 7, 112, 114, 105, 110, 116, 101, 114, 1, 2, 7, 0, 127, 0, 0, 1, 184, 11, 5, 104, 101, 108, 108, 111>>} = V2.encode(message)
    end
    ...
    test "decode/1 for UDP" do
      ...
      encoded = <<1, 2, 2, 7, 0, 127, 0, 0, 1, 160, 15, 0, 7, 112, 114, 105, 110, 116, 101, 114, 1, 2, 7, 0, 127, 0, 0, 1, 184, 11, 5, 104, 101, 108, 108, 111>>
